...
class _signupState extends State<signup> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(appBar: AppBar(title: Text('Signup'),),body: Column(children: [
      ...
      Text('Signup'),
        Form(
                                ...
                                }, child: loading ? CircularProgressIndicator(strokeWidth: 4,backgroundColor: Colors.white,): Text('Sign up')),
